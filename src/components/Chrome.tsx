...
export function Chrome() {
  ...
  {(displayMode==='anaglyph'||displayMode==='cd-only')&&<aside className="stereo-calibration" aria-label="3D calibration">
    ...
    <small>{displayMode==='cd-only'?'ALL DOTS SHARE ONE CONTINUOUS DEPTH. X/Y, SIZE AND BRIGHTNESS STAY FIXED; ONLY BINOCULAR DISPARITY CHANGES.':'RED-LEFT / CYAN-RIGHT GLASSES USUALLY NEED NO SWAP. ENABLE ONLY IF DEPTH IS FULLY REVERSED.'}</small>
  </aside>}</>
}
