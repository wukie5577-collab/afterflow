...
export function Chrome() {
  const mode=useAppStore(s=>s.mode), setMode=useAppStore(s=>s.setMode), muted=useAppStore(s=>s.muted), toggleMuted=useAppStore(s=>s.toggleMuted), quality=useAppStore(s=>s.quality), setQuality=useAppStore(s=>s.setQuality)
